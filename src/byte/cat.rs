...
impl CatStream {
    ...
    fn accumulate_into_cache(&mut self, is_eof: bool, bytes: usize, request: usize) -> Result<(bool, usize)> {
        ...
        self.cache.fill_buf(request, |request, buf| {
            debug_assert!(self.i < self.srcs.len());
            ...
            fn $name() {
                ...
                test_impl!(
                    ...
                    &[
                        ...
                        0x24, 0x25, 0x26, 0x27, 0x20, 0x29, 0x2a, 0x2b, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x30, 0x39, 0x3a,
                        0x3b, 0x3c, 0x3d, 0x3e, 0x3f, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x50, 0x59, 0x60, 0x61, 0x62, 0x63,
                        0x64
                    ]
                );
            }
